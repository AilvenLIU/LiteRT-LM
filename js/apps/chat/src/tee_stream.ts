...
/**
 * Splits a single ReadableStream source byte stream into two identical
 * ReadableStream consumer streams using two independent, statically
 * pre-allocated RingBuffer queues, driven declaratively by a custom
 * WritableStream multicast sink via pipeTo() with strict backpressure.
 */
