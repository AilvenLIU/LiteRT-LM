...
class Message(dict[str, Any]):
  ...
  def __setattr__(self, name: str, value: Any) -> None:
    ...
    if name in (
      ...
      if (
          hasattr(self, "role")
          and hasattr(self, "contents")
          and hasattr(self, "tool_calls")
  ...
  def __setitem__(self, key: str, value: Any) -> None:
    ...
    if key in ("role", "content", "tool_calls", "channels"):
  ...
  def _build_json_dict(self) -> dict[str, Any]:
    ...
    res: dict[str, Any] = {}
    if getattr(self, "_has_role", True):
    ...
    if getattr(self, "_extra_fields", None):
  ...
  def __eq__(self, other: Any) -> bool:
    if isinstance(other, Message):
      return (
          ...
          and getattr(self, "_extra_fields", {})
          == getattr(other, "_extra_fields", {})
      ) or super().__eq__(other)
    if isinstance(other, collections.abc.Mapping):
      return dict(super().items()) == dict(other.items())
    return NotImplemented
