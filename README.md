...
-   **Swift APIs**: Natively integrate LiteRT-LM into iOS and macOS applications
...
-   **LiteRT-LM CLI Update**: The command-line interface now supports full CPU
    and GPU backends across Linux, macOS, and Windows. See the
