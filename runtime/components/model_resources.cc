...
absl::StatusOr<const proto::TtsMetadata*> ModelResources::GetTtsMetadata() {
  return absl::UnimplementedError("GetTtsMetadata is not implemented.");
}

absl::StatusOr<const proto::AsrMetadata*> ModelResources::GetAsrMetadata() {
  return absl::UnimplementedError("GetAsrMetadata is not implemented.");
}

absl::StatusOr<absl::string_view> ModelResources::GetGenericBinaryDataBuffer(
