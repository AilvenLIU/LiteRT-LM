...
TEST_P(ConversationTest, GetTokensCount) {
  ASSERT_OK_AND_ASSIGN(auto model_assets,
                       ModelAssets::Create(GetTestdataPath(kTestLlmPath)));
  ASSERT_OK_AND_ASSIGN(auto engine_settings, EngineSettings::CreateDefault(
                                                 model_assets, Backend::CPU));
  ...
  ASSERT_OK_AND_ASSIGN(int initial_tokens, conversation->GetTokensCount());
  ...
  ASSERT_OK_AND_ASSIGN(int tokens_after, conversation->GetTokensCount());
  EXPECT_EQ(tokens_after, 20);
}

TEST_P(ConversationTest, GetTokensCountWithPreface) {
  ASSERT_OK_AND_ASSIGN(auto model_assets,
                       ModelAssets::Create(GetTestdataPath(kTestLlmPath)));
  ASSERT_OK_AND_ASSIGN(auto engine_settings, EngineSettings::CreateDefault(
                                                 model_assets, Backend::CPU));
