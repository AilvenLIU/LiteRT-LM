...
object ExperimentalFlags {
   ...
   *
   * Currently, this is only supported by Gemma4. The Gemma4 budget options are 70, 140, 280, 560,
   * or 1120 tokens. See https://ai.google.dev/gemma/docs/capabilities/vision#variable-resolution
   * for more details.
   *
