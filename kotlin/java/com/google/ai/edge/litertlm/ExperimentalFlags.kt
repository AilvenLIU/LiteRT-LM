...
object ExperimentalFlags {
   ...
   *
   * Note: When set before [Engine] initialization, this flag configures the vision model signature
   * selection during engine creation. It can also alter the per-message behavior of [Conversation].
   */
